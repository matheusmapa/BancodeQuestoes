...
function Dashboard({ user, onLogout }) {
  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case 'performance': return <PerformanceView detailedStats={realStats} simulations={mySimulations} allQuestions={allQuestions} onLaunchExam={(topics, count) => handleLaunchExam({ topics: topics }, count)} onLaunchSmartExam={handleLaunchSmartExam} onBack={() => handleViewSwitch('home')} areasBase={areasBase} />;
